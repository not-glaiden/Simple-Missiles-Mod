...
public class ConsoleBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(0, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public ConsoleBlockEntity(BlockPos position, BlockState state) {
		super(SimplemissilesModBlockEntities.CONSOLE.get(), position, state);
	}
