...
public class SimplemissilesModMenus {
	...
	public static final RegistryObject<MenuType<LaunchPadGuiMenu>> LAUNCH_PAD_GUI = REGISTRY.register("launch_pad_gui", () -> IForgeMenuType.create(LaunchPadGuiMenu::new));
