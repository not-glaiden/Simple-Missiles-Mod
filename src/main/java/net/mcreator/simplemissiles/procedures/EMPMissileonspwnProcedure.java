...
public class EMPMissileonspwnProcedure {
		...
		SimplemissilesMod.queueServerWork(50, () -> {
			if (entity.isAlive()) {
				if (world instanceof ServerLevel _level)
					FallingBlockEntity.fall(_level, BlockPos.containing(entity.getPersistentData().getDouble("x"), 300, entity.getPersistentData().getDouble("z")), SimplemissilesModBlocks.EMP_MISSILE.get().defaultBlockState());
